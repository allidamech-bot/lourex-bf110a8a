...
import type { EventLanguage, EventTimelineItem } from "@/features/event-system/types/eventTypes";

const labels = {
  en: {
    title: "Operational event timeline",
    empty: "No operational events are currently queued.",
  },
  ar: {
    title: "السجل الزمني للأحداث التشغيلية",
    empty: "لا توجد أحداث تشغيلية في القائمة حاليا.",
  },
} as const;
