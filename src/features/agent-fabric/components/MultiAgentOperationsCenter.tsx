...
const labels = {
  ...
  ar: {
    eyebrow: "ط°ظƒط§ط، ظ…طھط¹ط¯ط¯ ط§ظ„ظˆظƒظ„ط§ط،",
    title: "ظ†ط³ظٹط¬ ط§ظ„طھظ†ط³ظٹظ‚ ط§ظ„ط°ط§طھظٹ",
    description: "ظˆظƒظ„ط§ط، ظ…طھط®طµطµظˆظ† ط­طھظ…ظٹظˆظ† ظٹظ†ط³ظ‚ظˆظ† ط§ظ„طھظپظˆظٹط¶ ظˆط§ظ„طھط®ط·ظٹط· ط§ظ„ظ…ظˆط²ط¹ ظˆط¥ط´ط±ط§ظپ ط§ظ„طھظ†ظپظٹط° ط§ظ„ظ…ط­ظƒظˆظ… ظˆط§ظ„ط§ط³طھط±ط¯ط§ط¯ ط§ظ„ط¢ظ…ظ†.",
    loading: "ط¬ط§ط±ظٹ طھط­ط¶ظٹط± ظ†ط³ظٹط¬ ط§ظ„طھظ†ط³ظٹظ‚ ظ…طھط¹ط¯ط¯ ط§ظ„ظˆظƒظ„ط§ط،...",
  },
} as const;
      ...
      <div className="rounded-2xl border border-fuchsia-400/20 bg-[linear-gradient(135deg,rgba(217,70,239,0.13),rgba(15,23,42,0.94))] p-5">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[11px] uppercase tracking-[0.2em] text-fuchsia-200">{t.eyebrow}</p>
