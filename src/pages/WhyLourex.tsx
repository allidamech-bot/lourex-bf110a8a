...
const WhyLourex = () => {
  ...
  useEffect(() => {
    document.title = "Why LOUREX | Verified Factory Sourcing & Secure Trade";
    const meta = document.querySelector('meta[name="description"]');
    const content = "Six reasons merchants choose LOUREX: verified factories, milestone escrow, real-time tracking, pre-shipment inspection, multi-currency support & legal compliance.";
