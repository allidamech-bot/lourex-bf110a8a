...
const PredictiveIntelligencePage = lazy(
  () => import("@/pages/dashboard/PredictiveIntelligencePage"),
);
const PurchaseRequestsPage = lazy(
  () => import("@/pages/dashboard/PurchaseRequestsPage"),
);
const ProductsManagementPage = lazy(
  () => import("@/pages/dashboard/ProductsManagementPage"),
);
...
const EditRequestsPage = lazy(
  () => import("@/pages/dashboard/EditRequestsPage"),
);
const PartnerSettlementsPage = lazy(
  () => import("@/pages/dashboard/PartnerSettlementsPage"),
);
...
const SystemControlsPage = lazy(
  () => import("@/pages/dashboard/SystemControlsPage"),
);
const HealthPage = lazy(() => import("@/pages/dashboard/HealthPage"));
const OperationsBriefingPage = lazy(
  () => import("@/pages/dashboard/OperationsBriefingPage"),
);
const Admin = lazy(() => import("@/pages/Admin"));
const CustomerPortal = lazy(() => import("@/pages/customer/CustomerPortal"));
const CustomerOperationsPage = lazy(
  () => import("@/pages/customer/CustomerOperationsPage"),
);
const CustomerRequestsPage = lazy(
  () => import("@/pages/customer/CustomerRequestsPage"),
);
const CustomerRequestDetailProPage = lazy(
  () => import("@/pages/customer/CustomerRequestDetailProPage"),
);
const CustomerTrackingPage = lazy(
  () => import("@/pages/customer/CustomerTrackingPage"),
);
const CustomerTrackingProPage = lazy(
  () => import("@/pages/customer/CustomerTrackingProPage"),
);
  ...
  <div className="flex min-h-screen items-center justify-center bg-background px-4">
    <div className="w-full max-w-2xl rounded-[1.75rem] border border-destructive/30 bg-card p-8 shadow-[0_24px_70px_-45px_rgba(0,0,0,0.65)]">
      ...
      <p className="mt-4 text-sm leading-7 text-muted-foreground">
        Lourex cannot start authentication or database features until the
        runtime environment provides the Supabase project URL and publishable
        key.
      </p>
      ...
      <p className="mt-5 text-sm leading-7 text-muted-foreground">
        In Vercel, add these values in Project Settings &gt; Environment
        Variables. For local development, add them to your local .env file.
      </p>
    </div>
  </div>
);
            ...
            {isSupabaseConfigured ? (
              <AuthSessionProvider>
                <Suspense fallback={<PageLoader />}>
                  <Routes>
                    ...
                    <Route
                      path="/products"
                      element={<PageWithAI component={<ProductsPage />} />}
                    />
                    <Route
                      path="/products/:slug"
                      element={<PageWithAI component={<ProductDetailPage />} />}
                    />
                    <Route
                      path="/request"
                      element={<PageWithAI component={<RequestPage />} />}
                    />
                    <Route
                      path="/track"
                      element={<PageWithAI component={<TrackPage />} />}
                    />
                    ...
                    <Route
                      path="/privacy"
                      element={<PageWithAI component={<PrivacyPage />} />}
                    />
                    <Route
                      path="/terms"
                      element={<PageWithAI component={<TermsPage />} />}
                    />
                    <Route
                      path="/guidelines"
                      element={<PageWithAI component={<TermsPage />} />}
                    ...
                    <Route
                      path="/why-lourex"
                      element={<PageWithAI component={<WhyLourexPage />} />}
                    />
                    <Route
                      path="/contact"
                      element={<PageWithAI component={<ContactPage />} />}
                    />
                    ...
                    >
                      ...
                      <Route
                        ...
                        element={
                          <ProtectedRoute allowedRoles={INTERNAL_ROLES}>
                            <PageWithAI
                              component={<OperationsBriefingPage />}
                            />
                          </ProtectedRoute>
                        }
                      />
                      <Route
                        ...
                        element={
                          <ProtectedRoute
                            allowedRoles={PREDICTIVE_INTELLIGENCE_ROLES}
                          >
                            <PageWithAI
                      ...
                      <Route
                        ...
                        element={
                          <ProtectedRoute
                            allowedRoles={PRODUCT_MANAGEMENT_ROLES}
                          >
                            <PageWithAI
                      ...
                      <Route
                        ...
                        element={
                          <ProtectedRoute
                            allowedRoles={ACCOUNTING_DASHBOARD_UI_ROLES}
                          >
                      ...
                      <Route
                        ...
                        element={
                          <ProtectedRoute
                            allowedRoles={SYSTEM_DASHBOARD_UI_ROLES}
                          >
                            <PageWithAI component={<NotificationsPage />} />
                          </ProtectedRoute>
                        }
                      />
                      <Route
                    ...
                    >
                      <Route
                        index
                        element={<PageWithAI component={<CustomerPortal />} />}
                      />
                      <Route
                        path="operations"
                        element={
                          <ProtectedRoute allowedRoles={["customer"]}>
                            <PageWithAI
                              component={<CustomerOperationsPage />}
                            />
                          </ProtectedRoute>
                        }
                      />
                      ...
                      <Route
                        ...
                        element={
                          <ProtectedRoute allowedRoles={["customer"]}>
                            <PageWithAI
                              component={<CustomerRequestDetailProPage />}
                            />
                          </ProtectedRoute>
                        }
                      />
                      ...
                      <Route
                        ...
                        element={
                          <ProtectedRoute allowedRoles={["customer"]}>
                            <PageWithAI
                              component={<CustomerTrackingProPage />}
                            />
                          </ProtectedRoute>
                        }
                      />
              ...
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  <Route path="/why-lourex" element={<WhyLourexPage />} />
                  <Route path="/contact" element={<ContactPage />} />
                  <Route path="*" element={<SupabaseSetupError />} />
                </Routes>
              </Suspense>
            )}
          </BrowserRouter>
